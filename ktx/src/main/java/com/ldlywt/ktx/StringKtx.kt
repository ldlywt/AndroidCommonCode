...
fun Context.stringOf(@StringRes id: Int, vararg formatArgs: Any): String = getString(id, *formatArgs)

fun Context.stringOf(@StringRes id: Int): String = getString(id)
...
import com.ldlywt.base.global.Constants
